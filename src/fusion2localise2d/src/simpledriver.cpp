...
bool
SimpleDriver::compute( orca::GpsData  &gpsData,
		       orca::InsData &insData,
...
//     cout<<"TRACE(simpledriver.cpp): " << __func__ << endl;
    ...
    cout<<"TRACE(simpledrv): poseInMapGridCS: " << poseInMapGridCS << endl;
    cout<<"TRACE(simpledrv): antennaPoseInGps2LCS: " << antennaPoseInGps2LCS << endl;
    ...
    // Set uncertainties
    const double linearSigma = ((gpsData.horizontalPositionError>0.01)?gpsData.horizontalPositionError:0.1);
